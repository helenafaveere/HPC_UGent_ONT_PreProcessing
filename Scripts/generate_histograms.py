...
basecalled_file = f"ReadLengths/all_read_lengths_barcode{sample_num}.txt"
mapped_file = f"ReadLengths/all_mapped_read_lengths_barcode{sample_num}.txt"
...
plot_histogram(basecalled_lengths,
               f"Basecalled Read Lengths - Barcode {sample_num}",
               f"ReadLengths/Histogram/histogram_basecalled_barcode{sample_num}.png")

plot_histogram(mapped_lengths,
               f"Mapped Read Lengths - Barcode {sample_num}",
               f"ReadLengths/Histogram/histogram_mapped_barcode{sample_num}.png")

print(f"Histograms generated for barcode {sample_num}") 
